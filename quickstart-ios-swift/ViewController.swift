...
class ViewController: UIViewController, IVSBroadcastSession.Delegate {
    // MARK: - IBOutlets -
    ...
    // MARK: Amazon IVS Broadcast
    
    private let kIngestServer = "copy_from_ivs_console"
    private let kStreamKey = "copy_from_ivs_console"
    private var customImageSource : IVSCustomImageSource!
    private var broadcastSession: IVSBroadcastSession?
    
    func broadcastSession(_ session: IVSBroadcastSession, didChange state: IVSBroadcastSession.State) {
        print("IVSBroadcastSession did cange state \(state.rawValue)")
    }
    ...
    func setupIVS() {
        do {
            ...
            let customImageSource = broadcastSession.createImageSource(withName: "deepar-video-source")
            broadcastSession.attach(customImageSource, toSlotWithName: "default")
...
//        NotificationCenter.default.addObserver(self, selector: #selector(orientationDidChange), name: UIDevice.orientationDidChangeNotification, object: nil)
    ...
    override func viewDidAppear(_ animated: Bool) {
        // This is optional but recommended. It prevents your device from going to sleep while using the broadcast SDK,
